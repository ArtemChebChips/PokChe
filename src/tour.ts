...
export const tourSteps = [
  ...
  },
  {
    ...
    text: "Если ты новичок, проходи уроки по порядку: от карт к более сложным решениям. Здесь всегда можно продолжить с того места, где остановился. В отличие от моего Пежо.",
    tab: "learn",
    target: "lesson",
    pose: "point-right",
    place: "bottom",
