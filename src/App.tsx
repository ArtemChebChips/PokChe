...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="app-content" inert={tourStep !== null}>
          ...
          {screen === "main" && tab === "train" && (
            <>
              <h1>Тренажёры</h1>
              <p className="lead">
                Выбери навык. Решай по одной задаче и заканчивай, когда
                захочешь.
              </p>
              <button
                ...
                {allSkills.map((s, i) => (
                  <button key={s} disabled={loading} onClick={() => start([s])}>
                    ...
                    <span>
                      ...
                      <small>
                        {["betting", "ranges", "planning", "advanced"].includes(
                          s,
                        )
            ...
            <>
              ...
              {(task.cards || task.board) && (
                <section
                  className={
                    "table " +
                    (task.skill === "cards" ? "comparison-table" : "")
                  }
                >
              ...
              {task.selection ? (
                <p className="muted">
                  Выбрано {selected.length} из 5. Любая равноценная лучшая
                  пятёрка принимается.
                </p>
              ) : (
          ...
          {screen === "matrix" && (
            <>
              ...
              <h1>Матрица рук</h1>
              <p className="lead">
                Выберите клетку или найдите руку в списке. Это свободная
                матрица, без оценки стратегии.
              </p>
              <RangeMatrix />
          ...
          {screen === "formats" && (
            <article className="formats-guide">
              ...
              <p>
                ...
                выбранным столом обычно постоянны. Между раздачами можно
                закончить игру и забрать стоимость оставшихся фишек.
              </p>
              <p>
                Если стек уменьшился, его можно пополнить в пределах правил
                стола. Проигрыш всех фишек не означает выбывания из
                соревнования: в кэше нет общей турнирной дистанции и призовых
                мест.
              </p>
              <h2>Турнир — одна общая дистанция</h2>
              <p>
                Участники оплачивают вход — бай-ин — и получают стартовый стек.
                Турнирные фишки нельзя обменять на деньги напрямую: 10 000 в
                стеке не означают 10 000 ₽. Призы зависят от занятого места и
                структуры выплат.
              </p>
              <p>
                ...
                BB 100 — это 100 BB, а при BB 500 — уже 20 BB. Иногда
                добавляется анте — ещё одна обязательная ставка.
              </p>
              <p>
                Когда фишки заканчиваются, игрок выбывает. Некоторые турниры
                допускают повторный вход или докупку в оговорённый период.
                Просто уйти и забрать стоимость своего стека, как в кэше,
                нельзя.
              </p>
          ...
          {screen === "settings" && (
            <>
              ...
              <section className="info-box">
                ...
                <p>
                  <strong>Android:</strong> откройте HTTPS-ссылку в Chrome →
                  меню ⋮ → «Добавить на главный экран» → «Установить» (название
                  зависит от версии).
                </p>
                <p>
                  <strong>
                ...
                <p className="muted">
                  На телефоне адрес http://IP-компьютера не даёт полноценную
                  PWA. Нужен HTTPS. На компьютере localhost подходит для
                  проверки.
                </p>
              </section>
              <section className="info-box">
              ...
              <details className="info-box">
                ...
                <p>
                  Правила и формулы проверяются детерминированно. Эквити на
                  тёрне — полный перебор 44 риверов против указанной руки; ничья
                  даёт половину банка. Симуляция не используется.
                </p>
                <p>
